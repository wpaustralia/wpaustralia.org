...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'maddisondesigns' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'maddisondesigns' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'maddisondesigns' ),
		'repeat'    => esc_html__( 'Repeat All', 'maddisondesigns' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'maddisondesigns' ),
		'top center'    => esc_html__( 'Top Center', 'maddisondesigns' ),
		'top right'     => esc_html__( 'Top Right', 'maddisondesigns' ),
		'center left'   => esc_html__( 'Middle Left', 'maddisondesigns' ),
		'center center' => esc_html__( 'Middle Center', 'maddisondesigns' ),
		'center right'  => esc_html__( 'Middle Right', 'maddisondesigns' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'maddisondesigns' ),
		'bottom center' => esc_html__( 'Bottom Center', 'maddisondesigns' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'maddisondesigns')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'maddisondesigns' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'maddisondesigns')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'maddisondesigns' ),
		'italic'      => esc_html__( 'Italic', 'maddisondesigns' ),
		'bold'        => esc_html__( 'Bold', 'maddisondesigns' ),
		'bold italic' => esc_html__( 'Bold Italic', 'maddisondesigns' )
		);
