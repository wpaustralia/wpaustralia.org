	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<?php if ( is_sticky() && is_home() && ! is_paged() ) { ?>
			<div class="featured-post">
				<?php esc_html_e( 'Featured post', 'maddisondesigns' ); ?>
			</div>
		<?php } ?>
		...
		<?php }
			...
			<div class="entry-content">
				<?php the_content( wp_kses( __( 'Continue reading <span class="meta-nav"><i class="fa fa-angle-right"></i></span>', 'maddisondesigns' ), array(
					'span' => array(
						'class' => array()
						),
					'i' => array(
